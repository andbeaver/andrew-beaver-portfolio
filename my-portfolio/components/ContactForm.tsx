...
export default function ContactForm({
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm transition-shadow duration-300 hover:shadow-md">
      <h2
      ...
      {submitStatus === "success" && (
        ...
        >
          ...
          <button
            ...
            type="button"
            onClick={onReset}
            className="mt-2 text-sm font-semibold text-indigo-600 hover:text-indigo-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 rounded transition-colors"
          >
        ...
        >
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className={`border rounded-lg px-4 py-2.5 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus-visible:ring-2 focus:border-transparent focus:-translate-y-px focus:shadow-sm transition-all duration-150 disabled:opacity-60 disabled:cursor-not-allowed ${
                touched.name && errors.name
                  ? "border-red-400 focus-visible:ring-red-300"
                  : "border-slate-200 focus-visible:ring-indigo-400"
              }`}
            />
            {touched.name && errors.name && (
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select
              ...
              className={`border rounded-lg px-4 py-2.5 text-sm bg-white focus:outline-none focus-visible:ring-2 focus:border-transparent focus:-translate-y-px transition-all duration-150 appearance-none cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed ${
                touched.subject && errors.subject
                  ? "border-red-400 focus-visible:ring-red-300 text-slate-400"
                  : formData.subject
                  ? "border-slate-200 focus-visible:ring-indigo-400 text-slate-900"
                  : "border-slate-200 focus-visible:ring-indigo-400 text-slate-400"
              }`}
            >
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              aria-describedby={[
                ...
                .filter(Boolean)
                .join(" ")}
              className={`border rounded-lg px-4 py-2.5 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus-visible:ring-2 focus:border-transparent focus:shadow-sm transition-all duration-150 resize-none disabled:opacity-60 disabled:cursor-not-allowed ${
                touched.message && errors.message
                  ? "border-red-400 focus-visible:ring-red-300"
                  : "border-slate-200 focus-visible:ring-indigo-400"
              }`}
          ...
          {submitStatus === "error" && (
            <div
              role="alert"
              aria-live="assertive"
              className="flex items-start gap-3 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700 animate-[fadeIn_0.3s_ease]"
            >
              <svg
                aria-hidden="true"
