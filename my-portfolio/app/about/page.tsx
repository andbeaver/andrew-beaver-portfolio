            ...
            <div key={group.label}>
              ...
              <div className="flex flex-wrap gap-2">
                {group.skills.map((skill) => (
                  <span
                    key={skill}
                    className="bg-white border border-slate-200 rounded-lg px-3.5 py-1.5 text-sm text-slate-700 shadow-sm hover:border-indigo-300 hover:text-indigo-700 transition-colors"
                  >
                    {skill}
                  </span>
                ))}
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6 flex flex-col gap-2 shadow-sm">
            <div className="flex items-start justify-between gap-4 flex-wrap">
              <div>
                <p className="font-semibold text-slate-900">IT Programming</p>
                <p className="text-sm text-slate-500 mt-0.5">
                  Nova Scotia Community College - Halifax, NS
                </p>
              </div>
              <span className="shrink-0 inline-flex items-center bg-indigo-50 text-indigo-600 text-xs font-semibold px-2.5 py-1 rounded-full border border-indigo-100">
            ...
            <div className="flex items-start justify-between gap-4 flex-wrap">
              <div>
                <p className="font-semibold text-slate-900">
                  ...
                  <span className="font-normal text-slate-500"> - Marketing</span>
                </p>
                <p className="text-sm text-slate-500 mt-0.5">
                  Nova Scotia Community College - Dartmouth, NS
                </p>
              </div>
              <span className="shrink-0 inline-flex items-center bg-slate-100 text-slate-600 text-xs font-semibold px-2.5 py-1 rounded-full border border-slate-200">
                2018
              </span>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6 flex flex-col gap-2 shadow-sm">
            <div className="flex items-start justify-between gap-4 flex-wrap">
              <div>
                <p className="font-semibold text-slate-900">DELF B1 Certification</p>
                <p className="text-sm text-slate-500 mt-0.5">
